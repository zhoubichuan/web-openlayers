...
<template>
  <div>
    ...
    <label for="speed">
      速度:&nbsp;
      <input ref="speed1" type="range" min="10" max="999" step="10" value="60" />
    </label>
...
export default {
  ...
  mounted() {
    ...
    this.continueButton.addEventListener("click", this.continueAnimation, false)
  ...
  methods: {
    initMap() {
      ...
      this.speedInput = this.$refs.speed1
      this.startButton = this.$refs.startanimation
      this.pauseButton = this.$refs.pauseanimation
      this.continueButton = this.$refs.continueanimation
      this.stopButton = this.$refs.stopanimation
    },
    moveFeature(event) {
