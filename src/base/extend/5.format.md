...
- GeoJSON().readFeature(data)
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-2-5-1.vue" />
...
- GeoJSON()
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-2-5-1-2.vue" />
...
- EsriJSON().readFeature(data)
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-2-5-2.vue" />
...
- OSMXML().readFeature(data)
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-2-5-3.vue" />
...
- WKB().readFeature(data)
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-2-5-4.vue" />
...
- WKT().readFeature(data)
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-2-5-5.vue" />
...
- WMSGetFeatureInfo().readFeature(data)
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-2-5-6.vue" />
...
- WMTSCapabilities().read(data)
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-2-5-7.vue" />
...
- TopoJSON()
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-2-5-8.vue" />
...
- KML()
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-2-5-9.vue" />
