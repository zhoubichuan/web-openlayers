...
| constrainRotation | 旋转约束 | -    |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-1.vue" />
...
| multiWorld | 如果为 false，则视图受到约束，因此只能看到一个世界，并且您无法平移边缘 | -    |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-2.vue" />
...
| rotation | 以弧度为单位的视图的初始旋转（顺时针正旋转，0 表示北） | -    |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-3.vue" />
...
| enableRotation | 旋转控制 | -    |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-4.vue" />
...
| resolution | 地图的分辨率，单位并不是普通的单位面积的像素，而是单位像素表示的距离单位，比如 米/像素 | -    |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-5.vue" />
...
| resolutions | 如果指定，则确定缩放级别的分辨率 | -    |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-6.vue" />
...
| extent | 地图视图的初始范围 | 数组对象 – [left, bottom, right, top] |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-7.vue" />
...
| constrainOnlyCenter | 如果为真，范围约束仅适用于视图中心，而不适用于整个范围 | -    |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-8.vue" />
...
| smoothExtentConstraint | 如果为真，范围约束将平稳应用，即允许视图略微超出给定 extent | -    |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-9.vue" />
...
如果为真，视图在交互后将始终动画到最近的缩放级别；false 表示允许中间缩放级别
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-10.vue" />
...
如果为真，分辨率最小/最大值将顺利应用，即允许视图略微超过给定的分辨率或缩放边界
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-11.vue" />
...
富文本标签
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-12.vue" />
...
- getRotation 获取视图旋转。
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-13.vue" />
...
- centerOn
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-14.vue" />
...
## 3.change:resolution
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-4-15.vue" />
