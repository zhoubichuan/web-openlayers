...
| 鼠标滚轮缩放      | MouseWheelZoom  | 鼠标滚轮缩放地图                       |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-11-1.vue" />
...
| 鼠标滚轮缩放      | MouseWheelZoom  | 鼠标滚轮缩放地图             |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-11-2.vue" />
...
- 全屏拖动、旋转和缩放
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-11-5.vue" />
...
绘制地理要素功能
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-11-8.vue" />
...
| modify | 更改要素     |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-11-12.vue" />
...
| pinchzoom | 手指进行缩放，针对触摸屏 |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-11-15.vue" />
...
鼠标的用户自定义事件基类
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-11-16.vue" />
...
| snap   | 鼠标捕捉，当鼠标距离某个要素一定距离之内，自动吸附到要素 |
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-11-17.vue" />
...
## 18.翻译功能
  ...
  <Container url="http://localhost:8090/resume/demo/?type=openlayers&name=1-1-11-18.vue" />
