...
<template>
  ...
  <button ref="zoom-out">Zoom out</button>
  <button ref="zoom-in">Zoom in</button>
</template>
...
<template>
  ...
  <button ref="zoomtoswitzerland">Zoom to Switzerland</button> (best fit).<br />
  <button ref="zoomtolausanne">Zoom to Lausanne</button> (with
  minresolution),<br />
  <button ref="centerlausanne">Center on Lausanne</button>
</template>
...
export default {
  beforeCreate() {
    ...
    appendJQCDN(
      "https://cdn.polyfill.io/v3/polyfill.min.js?features=fetch,requestAnimationFrame,Element.prototype.classList,TextDecoder"
    )
    appendJQCDN(
